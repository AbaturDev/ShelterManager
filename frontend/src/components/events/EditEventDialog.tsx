...
export const EditEventDialog = ({
  ...
  const {
    ...
    defaultValues: {
      costCurrencyCode: event.cost?.currencyCode ?? "PLN",
      userId: event.userId ?? "",
    },
  });
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) => {
      ...
      return EventsService.updateEvent(event.id, {
        title: data.title,
    ...
    onSuccess: () => {
      ...
      toaster.create({
        type: "success",
        title: t("success"),
        description: t("events.edit.toast.success"),
        closable: true,
      });
      onSuccess();
      reset();
    ...
    onError: () => {
      toaster.create({
        type: "error",
        title: t("error"),
        description: t("events.edit.toast.error"),
        closable: true,
      });
      onClose();
      reset();
    ...
    <Portal>
      ...
      >
        ...
        <Dialog.Positioner>
          <Dialog.Content>
            <Dialog.Header>
              <Dialog.Title>{t("events.edit.dialogTitle")}</Dialog.Title>
                ...
                >
                  ...
                  <Field.Root>
                    ...
                    <Flex align="center" w="100%" gap={2}>
                      <Input
                        defaultValue={event.cost?.amount}
                        w="80%"
                        type="number"
                        min="0"
                        step="0.01"
                      ...
                      <NativeSelect.Root w="20%">
                        <NativeSelect.Field
                          ...
                          defaultValue={event.cost?.currencyCode ?? "PLN"}
                        >
